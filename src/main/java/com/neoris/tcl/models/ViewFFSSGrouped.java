...
@Entity
@Table(name = "ROLLUPVIEWFFSSGROUPED")
public class ViewFFSSGrouped implements Serializable{
	...
	public ViewFFSSGrouped(Long num, int companyid, String periodname, String costcenter, String hfmcode,
			String accountid, String icp, String partnerid, String tpname, String omit, String errortext, Long amount,
			String hfmparent) {
	...
	public String toString() {
		return "ViewFFSSGrouped [num=" + num + ", companyid=" + companyid + ", periodname=" + periodname
				...
				+ ", partnerid=" + partnerid + ", tpname=" + tpname + ", omit=" + omit + ", errortext=" + errortext
				+ ", amount=" + amount + ", hfmparent=" + hfmparent + "]";
	}
